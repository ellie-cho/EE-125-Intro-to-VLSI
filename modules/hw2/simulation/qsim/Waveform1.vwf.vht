...
-- *****************************************************************************
-- Generated on "05/03/2023 17:46:58"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          cluster_counter
-- 
...
ENTITY cluster_counter_vhd_vec_tst IS
END cluster_counter_vhd_vec_tst;
ARCHITECTURE cluster_counter_arch OF cluster_counter_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL ssd : STD_LOGIC_VECTOR(0 TO 6);
SIGNAL x : STD_LOGIC_VECTOR(0 TO 14);
SIGNAL y : STD_LOGIC_VECTOR(3 DOWNTO 0);
COMPONENT cluster_counter
	PORT (
	ssd : OUT STD_LOGIC_VECTOR(0 TO 6);
	x : IN STD_LOGIC_VECTOR(0 TO 14);
